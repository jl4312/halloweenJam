...
public class ProjectileBase : MonoBehaviour {
		...
		public float accurancyRadius = 0f;
		...
		public void SetNewTarget(GameObject target){
			...
			Vector3 tmp = new Vector3 (Random.Range (-1 * accurancyRadius, accurancyRadius), 0, Random.Range (-1 * accurancyRadius, accurancyRadius));

			tmp *= 1 - accurancy;

			this.targetTransform.position = this.targetTransform.position + tmp;
			ready = true;
